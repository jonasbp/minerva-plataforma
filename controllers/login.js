...
const UserField = Joi.object().keys({
    ...
    birthday: Joi.number().interger().min(1).max(31).required(),
    birthmonth: Joi.number().interger().min(1).max(12).required(),
    birthyear: Joi.number().interger().min(1900).max(2005).required(),
